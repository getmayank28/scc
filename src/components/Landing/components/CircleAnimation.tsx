...
export default function AnimatedCircles({
  ...
  return (
    <div className="w-[500px] ml-10 h-[500px] relative rounded-full  flex flex-col items-center justify-center p-8">
        ...
        <div className="relative  w-[400px] h-[400px]">
          {circles.map((circle) => {
            return (
              <div
                key={circle.id}
                className={`absolute group top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ${circle.size} border border-primary-orange/60 bg-primary-orange/10 rounded-full flex items-center justify-center text-white font-medium text-center p-4 shadow-lg transition-all duration-700 ease-out ${
