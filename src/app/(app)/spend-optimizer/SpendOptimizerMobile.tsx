...
import { categories, FormData, FormErrors, SpendTransaction } from "./data";
...
export default function SpendOptimizerMobile({
  ...
  return (
    <div className="space-y-6 py-6 hidden max-md:block">
      <div>
        <div className="flex gap-2 items-center">
          <div
            className={`rounded-lg flex justify-center items-center text-xl h-9 w-9 border-2 bg-[#E0EAFF] text-[#6496FF] border-[#6496FF] font-bold`}
          >
            02
          </div>
          <Typography
      ...
      <div className="flex flex-col gap-4">
        <div className="space-y-2">
          <Label className="text-base text-white/80 font-semibold">
            Transaction Mode
          </Label>
          <RadioGroup
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="online-mobile" className="text-white">
                Online
              </Label>
            </div>

            <div className="flex items-center space-x-2">
              <RadioGroupItem value="offline" id="offline-mobile" />
              <Label htmlFor="offline-mobile" className="text-white">
                Offline
              </Label>
            </div>
          </RadioGroup>
