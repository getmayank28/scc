...
import { useCreateCardMutation } from "@/store/admin";
import { Loader2 } from "lucide-react";

const AddCard = ({ open, onChange }: {
  open: boolean;
  onChange: () => void;
}) => {
  ...
  return (
    ...
    >
      <Typography variant="caption" className="text-sm font-semibold opacity-100 mb-5">Add a new card</Typography>
