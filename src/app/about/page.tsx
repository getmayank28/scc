  ...
  return (
    <div className="bg-[#101010] min-h-[100vh]">
      ...
      <BackgroundRippleEffect rows={10} />
        ...
        <div className="flex flex-col justify-center items-center z-10 px-4 max-md:mt-14">
          <div className="max-w-[984px] mx-auto text-center">
          <h1 className="text-[#FFF] max-md:hidden text-center font-butlerpro text-[80px] font-medium leading-[110%] tracking-[-6px] max-md:text-[50px] max-md:tracking-[-0.4px]">
              Make Smarter Credit
            </h1>
            <h1 className="text-[#FFF] hidden max-md:block text-center font-butlerpro text-[80px] font-medium leading-[110%] tracking-[-6px] max-md:text-[50px] max-md:tracking-[-0.4px]">
              Make Smarter Credit Choices
            </h1>
            <div className="flex justify-center gap-4">
              <h1 className="text-[#FFF] text-center font-butlerpro text-[80px] max-md:hidden font-medium leading-[110%] tracking-[-6px] max-md:text-[56px] max-md:tracking-[-0.4px]">
                Choices
              </h1>
            ...
            <p className="text-white max-md:text-center mt-2 max-md:mx-4 max-w-4xl mx-auto opacity-70 text-center font-satoshi max-md:mt-2 text-[20px] max-md:text-[16px] font-normal leading-[150%] tracking-[-2%] max-md:tracking-[-0.48px] [font-feature-settings:'ss03_on']">
